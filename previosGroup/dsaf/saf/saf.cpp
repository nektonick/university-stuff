...
saf::saf(QWidget *parent)
    ...
    , ui(new Ui::saf)
{
    //QTextCodec::setCodecForcStrings(QTextCodec::codecForName("KOI-8R"));
    ui->setupUi(this);
    ui->size_n->setMinimum(0);
    ui->size_n->setMaximum(100000);
...
//---Быстрая сортировка---
int saf::qs_partition(int a[], int l, int h)
{
    int x = a[h];
    int i = (l - 1);
